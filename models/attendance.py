...
class BHHrAttendance(models.Model):
    ...
    attendance_location = fields.Many2one('hr.attendance.location', 'Check in location', default=lambda self: self.env.ref('bh_hr_attendance.attendance_location_company', raise_if_not_found=False))
